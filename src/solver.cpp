...
string Solver<Dtype>::SnapshotToBinaryProto() {
  ...
  if(param_.snapshot_twobit()){
    LOG(INFO) << "--------------------";
    LOG(INFO) << "--------------------";
    model_filename = SnapshotFilename(".caffemodel.tb");
    LOG(INFO) << "Snapshotting twobit weights to proto file " << model_filename;
    NetParameter net_param_tn;
    net_->TwobitToProto(&net_param_tn);
    WriteProtoToBinaryFile(net_param_tn, model_filename);
  }
